...
| [Release-control candidates](firmware/RELEASE_CONTROL.md) | Release and guarded action callers, carrier methods, caller record writes, construction owner joins, receiver selection and conditional endpoint/native inputs, six-input frontend, and bounded selector-to-key lookups |
