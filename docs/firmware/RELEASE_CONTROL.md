...
For cached-root construction, receiver selection, and the conditional endpoint,
see the [release service](RELEASE_SERVICE.md).
...
**Next evidence:** [Release-body consumers](../RESEARCH.md#r-release-body-effect).
...
### Guard outcomes and bit-state predicate
...
### Carrier construction and dynamic methods
...
**Next evidence:** [Guard state and carrier methods](../RESEARCH.md#r-action-carrier).
...
<a id="constructed-service-and-receiver-selection"></a>

[Constructed service and receiver selection](RELEASE_SERVICE.md#constructed-service)

<a id="conditional-receiver-endpoint"></a>

<a id="conditional-receiver-table-endpoint"></a>

[Conditional receiver-table endpoint](RELEASE_SERVICE.md#conditional-receiver-endpoint)
