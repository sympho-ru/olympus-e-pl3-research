...
USB reporting, transition policy, communication state, and MTP lifecycle have
separate references: [USB state](USB_STATE.md), [USB policy](USB_POLICY.md),
[USB lifecycle](USB_LIFECYCLE.md), and [MTP lifecycle](MTP_LIFECYCLE.md).
...
that this body consumes the record built by the [MTP submitter](MTP_LIFECYCLE.md#mtp-event-pump)
...
<details>
<summary>Links to sections moved from this page</summary>

<a id="named-usb-state-reporting-wrapper"></a>

<a id="usb-state-wrapper"></a>

[Named USB-state reporting wrapper](USB_STATE.md#usb-state-wrapper)

<a id="candidate-connection-callback-byte-stores-and-consumer"></a>

<a id="usb-connect-stores"></a>

[Candidate connection callback, byte stores, and consumer](USB_STATE.md#usb-connect-stores)

<a id="pc-usb-transition"></a>

<a id="pcusb-state-transition-policy-and-callers"></a>

[PC/USB state-transition policy and callers](USB_POLICY.md#pc-usb-transition)

<a id="communication-cycle"></a>

<a id="communication-disconnectconnect-state-machine"></a>

[Communication disconnect/connect state machine](USB_LIFECYCLE.md#communication-cycle)

<a id="usb-disconnect-name-maps"></a>

<a id="usb-labelled-name-maps-and-lookup-boundaries"></a>

[USB-labelled name maps and lookup boundaries](USB_LIFECYCLE.md#usb-disconnect-name-maps)

<a id="mtp-communication-lifecycle"></a>

<a id="named-mtp-communication-lifecycle-callers"></a>

[Named MTP communication lifecycle callers](MTP_LIFECYCLE.md#mtp-communication-lifecycle)

<a id="mtp-lifecycle-owner"></a>

<a id="range-only-lifecycle-aggregate-and-state-selector-candidates"></a>

[Range-only lifecycle aggregate and state-selector candidates](MTP_LIFECYCLE.md#mtp-lifecycle-owner)

<a id="mtp-event-pump"></a>

<a id="receive-record-submission-and-pump-join"></a>

[Receive-record submission and pump join](MTP_LIFECYCLE.md#mtp-event-pump)
